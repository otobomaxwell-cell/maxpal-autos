      ...
      <div className="mx-auto max-w-295 px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-line border border-line">
          {serviceCategories.map((category) => {
            ...
            return (
              <div key={category.id} className="bg-surface p-6">
                <div className="w-9 h-9 flex items-center justify-center text-brand-deep border-t-[3px] border-brand pt-2 mb-3.5">
          ...
          <div className="bg-dark text-dark-ink p-6">
            <div className="w-9 h-9 flex items-center justify-center text-brand border-t-[3px] border-brand pt-2 mb-3.5">
            ...
            <p className="text-[0.9375rem] text-dark-ink-mute">
              Selected repairs at your home, workplace or vehicle location. Call with your
              registration, location and problem to check suitability.
            </p>
          </div>
        </div>
      </div>
